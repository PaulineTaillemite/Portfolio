        ...
        <div className="container py-10 lg:py-20 ">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 place-items-center">
                ...
                <section className=' space-y-7 lg:max-w-[380px]'>
                            ...
                            initial="hidden"
                            whileInView={"show"}
                            className='text-[#80dce0]  border-b-2 border-[#80dce0] text-xl font-bold p-1 flex items-center gap-4 group' > Download my resume {" "} <FaArrowRight className='text-sm group-hover:translate-x-2 transition duration-200' /> </motion.button>
